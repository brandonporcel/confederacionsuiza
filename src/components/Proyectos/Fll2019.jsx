...
export default function Fll2019() {
	return (
		<ProjectContainer
			...
			mainImg="./images/proyectos/fll2019/torneo-fll2019.png"
			when="2019"
			specialty="c"
		>
			...
			>
				...
				<br />
				<h4>Testimonio de Facundo Bermudes, integrante de Convergencia 26</h4>

				<audio controls>
					<source src="./audio/fll2019.ogg" type="audio/ogg" />
					Your browser does not support the audio element.
				</audio>
				<audio controls>
					<source src="./audio/fll2019-2.ogg" type="audio/ogg" />
					Your browser does not support the audio element.
				</audio>
			</SubTitleAndDescription>
			<SubTitleAndDescription
