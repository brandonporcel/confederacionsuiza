	...
	return (
		<ProyectoContainer>
			<div className="projectCtnBackground">
				<h2>Flecha Cosmica: Los chicos ganaron la FLL y viajaron a Houston!</h2>
				<div className="tags">
					<span>
						{mes}, {ano}
					</span>
				...
				>
					<p>
						...
						puesto del torneo Nacional First Lego League (FLL) 2018 y lograron
						la clasificacion al torneo mundial de Robotica que se llevo a cabo
						en Houston, Estados Unidos del 17 al 20 de abril de 2019.
					</p>
					<p>
						El equipo llamado "Flecha Cósmica", siguiendo la consigna del
						torneo, crearon un robot que monitorea la salud mental de los
						astronautas y busca resolver problemas anímicos generados por la
						soledad de los viajes espaciales.
					</p>
					<br />
					<p>
						Los estudiantes que representaron a la Argentina en el World
						Championship FFL y para poder viajar a la competencia, juntaron
						fondos por medio de rifas y festivales en la escuela como ferias de
						plato. Además, la fundación del Banco Ciudad y el Ministerio de
						Educación ayudaron a completar lo que necesitan para el viaje.
					</p>
					<br />
					<p>
						Se trata de un software "sensorial" que analiza los cambios físicos
						y emocionales de una persona. Tras consultar con psicólogos, los
						chicos crearon el programa que registra cualquier modificación en la
						conducta del astronauta y genera aromas, canciones o imágenes que le
						producen placer.
					</p>
					<p>
						Para clasificar al Mundial, los jóvenes compitieron contra otras 10
						escuelas. Este es un torneo internacional que se realiza en 80
						países y del que participaron más de 320 mil alumnos. La idea es que
						mediante sistemas de robots, los chicos aprendan de ciencia y
						tecnología de forma práctica.
					</p>
					<br />
					<p>
						En cada First Lego League, la consigna es diferente. En esta
						oportundidad, se llamó “En Órbita”, es decir, la exploración
						espacial y los desafíos que eso trae. Por eso, los alumnos debieron
						ensamblar las piezas y programar la lógica de robot Lego utilizando
						la tecnología EV3 Mindstorms para que supere una serie de obstáculos
						de forma autónoma a lo largo de 15 misiones en una alfombra gigante,
						como reparar paneles solares de la nave, esquivar un cráter o llegar
				...
				>
					<p>
						Los docentes/mentores de los chicos durante el proceso fueron
						Silvina Rodriguez, Mariano Santamarina y Pablo Fiscella.
					</p>
				</SubTitleAndDescription>
